        ...
        <div className="pt-12 border-t border-zinc-900 mt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-zinc-900/30 p-6 border border-zinc-800">
              <h3 className="text-brand-red font-bold uppercase tracking-wider text-sm mb-3">Premium Quality</h3>
            ...
            <div className="bg-zinc-900/30 p-6 border border-zinc-800">
              <h3 className="text-brand-red font-bold uppercase tracking-wider text-sm mb-3">Unisex by Default</h3>
              <p className="text-sm text-zinc-400 leading-relaxed">
            ...
            <div className="bg-zinc-900/30 p-6 border border-zinc-800">
              <h3 className="text-brand-red font-bold uppercase tracking-wider text-sm mb-3">Community First</h3>
              <p className="text-sm text-zinc-400 leading-relaxed">
